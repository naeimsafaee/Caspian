<div class="web-item padding-item col-lg-3 col-md-4 col-sm-12">
    <div class="row">
                ...
                <ul class="footer-list">
                    {{-- <li>
                         <a class="flex-box" href="{{ route('dashboard') }}">
                             <span class="flex-box @if(url()->current() == route('dashboard')) active_radio_button @endif">
                                 <span class="on-hover @if(url()->current() == route('dashboard')) active_radio_button @endif"></span>
                             </span>
                             داشبورد
                         </a>
                     </li>--}}
                    <li>
                        <a class="flex-box" href="{{ route('exchange') }}">
                            <span class="flex-box">
                    ...
                    <li>
                        <a class="flex-box" href="{{ route('trade_single' , 'BTC-USDT') }}">
                            <span class="flex-box">
                                <span class="on-hover"></span>
                            </span>
                            بازار معاملاتی
                    ...
                    <li>
                        <a class="flex-box" href="{{ route('copytrade') }}">
                            <span class="flex-box">
                                <span class="on-hover"></span>
                            </span>
                            کپی تریدینگ
        ...
        @if(!auth()->guard('clients')->user()->is_trader && \App\Models\Trader::query()->where('status' , 'requested')->count() == 0)
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="items justify-content-start  position-relative">
                    <img class="z-index-0 bg" src="{{asset('assets/photo/row-item.png')}}">
                    <h5 class="bold-text text-center">
                    ...
                    <a class="flex-box ask-me" href="{{ route('copytrade_request') }}">
                        ثبت نام کن
                    </a>
                </div>
            </div>
