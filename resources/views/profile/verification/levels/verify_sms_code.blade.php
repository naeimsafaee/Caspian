...
@section('content_head')
    <div class="history-item flex-box">
        <a>ارتقا حساب کاربری </a>
        <img src="{{asset('assets/icon/grey-arrow.svg')}}">
        <a>تایید شماره تلفن</a>
    </div>
@endsection
        ...
        <div class="overflow-visible items  position-relative">
            ...
            <div class="row">
                <div class="padding-item col-lg-6 col-md-6 col-sm-12">
                    <form method="post" action="{{ route('submit_sms_verify') }}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12 ">
                                <div class="input-row">
                                    ...
                                    <input type="text" placeholder="کد تایید خود را وارد کنید." name="code">
                                </div>
                            </div>
                            <div class="col-lg-12 ">
                                <div class="input-row">
                                    <button type="submit" class="p-button button flex-box col-lg-12"> ارسال کد </button>
                                </div>
                            </div>
                        </div>
                    </form>
